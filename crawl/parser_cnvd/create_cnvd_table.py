...
class add_cnvd(db.Model):
    ...
    vul_type = db.Column(String(100), server_default="")
    ...
    refer_link = db.Column(String(288), server_default="")
    solve_way = db.Column(Text, server_default="")
    describe = db.Column(Text, server_default="")
    patch = db.Column(String(100), server_default="")
