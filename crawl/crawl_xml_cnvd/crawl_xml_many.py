...
url1 = 'https://www.cnvd.org.cn/shareData/list?max=10&offset=0'
list_href = []
num = 0
list_title = []
...
def get_data(num):
    url = 'https://www.cnvd.org.cn/shareData/list?max=10&offset={}'.format(num)
    ...
    for items in a_td:
        ...
        file = '/home/shijiuyi/Desktop/other_crawl/crawl_cnvd_list/xml_cnvd/{}'.format(title)
