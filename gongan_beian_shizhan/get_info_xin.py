...
def into_url(domain_name):
    ...
    if error:
        ...
        if right:
            ...
            try:
                try:
                    if bowser.find_element_by_xpath('/html/body/div[1]/div[2]/div[3]/div[1]/table'):
                        ...
                        if domain_name == list[3]:
                            ...
                            db.session.commit()
                            time.sleep(1)
                            bowser.get(url="http://www.beian.gov.cn/portal/index.do")
                            bowser.find_element_by_xpath('//*[@id="searchtype"]/option[2]').click()
                            time.sleep(0.5)
                    ...
                    # if bowser.find_element_by_xpath('//*[@id="kong_wzbah"]'):
