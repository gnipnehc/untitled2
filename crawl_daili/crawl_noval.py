...
def get_data():
    url = 'http://www.shuquge.com/txt/8194/index.html'
    headers = {'User-Agent': random.choice(User_Agent),
               'Cookie': 'Hm_lvt_3806e321b1f2fd3d61de33e5c1302fa5=1595294839; bcolor=; font=; size=; fontcolor=; width=; Hm_lpvt_3806e321b1f2fd3d61de33e5c1302fa5=1595303449'}
    ...
    for url1, title in chapter[20:]:
        # print(url1)
        # print(title)
        chapter_url = 'http://www.shuquge.com/txt/8194/'+url1
        # print(chapter_url)
        ...
        file = '/home/shijiuyi/Desktop/other_crawl/crawl_noval/ming/'
        ...
        with open(u_file, 'w') as f:
            for con in content:
                contents = con.strip()+'\n'
                content1 = contents.replace('请记住本书首发域名：www.shuquge.com。书趣阁_笔趣阁手机版阅读网址：m.shuquge.com', '')
                f.write(content1)
